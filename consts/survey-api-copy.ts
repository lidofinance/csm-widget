...
export const SURVEY_API_COPY: Record<string, string> = {
  ...
  DVT_MAIN_ADDRESS_MISMATCH:
    "The main address does not match the operator's reward address",
  DVT_NOT_REJECTED:
    'You can resubmit only after the previous form was rejected',
  DVT_SIGNATURE_INVALID: 'One of the signatures could not be verified',
  DVT_CLUSTER_MEMBER_NOT_IN_ICS: 'A cluster member is not part of the ICS set',
