...
test.describe('Operator with keys. IDVTC. Application status', async () => {
  ...
  test('Should show pending status when in review', async ({
    widgetService,
    httpMockerService,
  }) => {
    const status =
  ...
  test('Should show approved status', async ({
    widgetService,
    httpMockerService,
  }) => {
    const status =
  ...
  test('Should show rejected status with reason and apply again', async ({
    widgetService,
    httpMockerService,
  }) => {
