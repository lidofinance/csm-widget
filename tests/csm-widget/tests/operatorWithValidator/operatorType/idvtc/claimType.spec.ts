...
test.describe(
  ...
  () => {
    ...
    test('Should show the claim notification, badge and claim button', async ({
      widgetService,
    }) => {
    ...
    test('Should open the claim page from the claim button', async ({
      widgetService,
    }) => {
      const operatorType = widgetService.operatorType;
      await operatorType.openTypePage();
    ...
    test('Should open the claim page from the notification', async ({
      widgetService,
    }) => {
      const operatorType = widgetService.operatorType;
      await operatorType.openTypePage();
    ...
    test('Should show the claim page content', async ({ widgetService }) => {
    ...
    test('Should show the parameter changes (current vs new)', async ({
      widgetService,
    }) => {
      const claim = widgetService.operatorType.claimIdvtc;
      await claim.open();
