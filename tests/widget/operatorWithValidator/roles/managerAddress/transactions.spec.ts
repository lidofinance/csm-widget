...
test.describe('Roles. Manager Address. Transactions.', () => {
  ...
  test('Propose a new Manager Address with valid input', async ({
    widgetService,
  }) => {
  ...
  test('Repropose a new Manager Address', async ({ widgetService }) => {
    const managerAddressPage = widgetService.rolesPage.managerAddressPage;
  ...
  test('Revoke Manager role change', async ({ widgetService }) => {
    const managerAddressPage = widgetService.rolesPage.managerAddressPage;
