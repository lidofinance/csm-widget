...
test.describe('Operator with keys. ICS. Apply application. Socials', async () => {
  ...
  test(
    qase(369, 'Check socials text appearance'),
    async ({ widgetService }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
  ...
  test(
    qase(370, 'Check Twitter section appearance'),
  ...
  test(
    qase(371, 'Check Discord section appearance'),
    async ({ widgetService }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
  ...
  test(
    qase(372, 'Should copy Twitter message to post after click to copy button'),
    async ({ widgetService, secretPhrase }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
  ...
  test(
    qase(373, 'Should copy Discord message to post after click to copy button'),
    async ({ widgetService, secretPhrase }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
  ...
  test(
    qase(374, 'Should correctly paste Twitter proof link'),
    async ({ widgetService }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
  ...
  test(
    qase(375, 'Should correctly paste Discord proof link'),
    async ({ widgetService }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
  ...
  test(
    qase(376, 'Should show error if paste incorrect Twitter proof link'),
    async ({ widgetService }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
  ...
  test(
    qase(377, 'Should show error if paste incorrect Discord proof link'),
    async ({ widgetService }) => {
      const applicationForm = widgetService.operatorType.applicationForm;
