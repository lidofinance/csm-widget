...
import { LOW_TIMEOUT } from '../../../../shared/consts/timeouts';
import { OFAC_MODAL_TEXT } from '../../../../shared/consts/texts.const';
  ...
  test(
    ...
    async ({ widgetService }) => {
      await test.step('Submit keys', async () => {
        ...
        const keysGeneratorService = new KeysGeneratorService({ isCM: true });
