...
export const CSModuleAbi = [
  {
    ...
    inputs: [],
    outputs: [
      { name: '', type: 'address', internalType: 'contract IAccounting' },
    ],
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: '', type: 'address', internalType: 'contract IExitPenalties' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: '', type: 'address', internalType: 'contract ILidoLocator' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'maxDepositAmount', type: 'uint256', internalType: 'uint256' },
      { name: 'pubkeys', type: 'bytes[]', internalType: 'bytes[]' },
      { name: 'keyIndices', type: 'uint256[]', internalType: 'uint256[]' },
      { name: 'operatorIds', type: 'uint256[]', internalType: 'uint256[]' },
      { name: 'topUpLimits', type: 'uint256[]', internalType: 'uint256[]' },
    ],
    outputs: [
  ...
  },
  {
    ...
    inputs: [{ name: 'maxCount', type: 'uint256', internalType: 'uint256' }],
    outputs: [
      { name: 'operatorsLeft', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorIds', type: 'bytes', internalType: 'bytes' },
      { name: 'vettedSigningKeysCounts', type: 'bytes', internalType: 'bytes' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    outputs: [
      { name: 'nodeOperatorIds', type: 'uint256[]', internalType: 'uint256[]' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ name: 'keys', type: 'bytes', internalType: 'bytes' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', type: 'uint256', internalType: 'uint256' },
      { name: 'proofSlotTimestamp', type: 'uint256', internalType: 'uint256' },
      { name: 'publicKey', type: 'bytes', internalType: 'bytes' },
      { name: 'eligibleToExitInSec', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [{ name: '', type: 'bool', internalType: 'bool' }],
    stateMutability: 'view',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: 'depositsCount', type: 'uint256', internalType: 'uint256' },
      { name: 'depositCalldata', type: 'bytes', internalType: 'bytes' },
    ],
    outputs: [
      { name: 'publicKeys', type: 'bytes', internalType: 'bytes' },
      { name: 'signatures', type: 'bytes', internalType: 'bytes' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'exitType', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', type: 'uint256', internalType: 'uint256' },
      { name: 'penaltyType', type: 'bytes32', internalType: 'bytes32' },
      { name: 'amount', type: 'uint256', internalType: 'uint256' },
    ...
    inputs: [
      {
        ...
        components: [
          { name: 'nodeOperatorId', type: 'uint256', internalType: 'uint256' },
          { name: 'keyIndex', type: 'uint256', internalType: 'uint256' },
          { name: 'exitBalance', type: 'uint256', internalType: 'uint256' },
          { name: 'slashingPenalty', type: 'uint256', internalType: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', type: 'uint256', internalType: 'uint256' },
      { name: 'keyIndex', type: 'uint256', internalType: 'uint256' },
      { name: 'currentBalanceWei', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorIds', type: 'uint256[]', internalType: 'uint256[]' },
      { name: 'bondLockNonces', type: 'uint256[]', internalType: 'uint256[]' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorIds', type: 'bytes', internalType: 'bytes' },
      { name: 'exitedValidatorsCounts', type: 'bytes', internalType: 'bytes' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', type: 'uint256', internalType: 'uint256' },
      { name: 'targetLimitMode', type: 'uint256', internalType: 'uint256' },
      { name: 'targetLimit', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  { type: 'error', name: 'CannotAddKeys', inputs: [] },
  { type: 'error', name: 'DepositInfoIsNotUpToDate', inputs: [] },
  {
    type: 'error',
  ...
  { type: 'error', name: 'InvalidManagerAddress', inputs: [] },
  { type: 'error', name: 'InvalidRewardAddress', inputs: [] },
  { type: 'error', name: 'InvalidVetKeysPointer', inputs: [] },
  { type: 'error', name: 'InvalidWithdrawnValidatorInfo', inputs: [] },
  { type: 'error', name: 'KeysLimitExceeded', inputs: [] },
  ...
  { type: 'error', name: 'NotEnoughKeys', inputs: [] },
  ...
  { type: 'error', name: 'SigningKeysInvalidOffset', inputs: [] },
  { type: 'error', name: 'SlashingPenaltyIsNotApplicable', inputs: [] },
  { type: 'error', name: 'UnreportableBalance', inputs: [] },
  { type: 'error', name: 'ValidatorSlashingAlreadyReported', inputs: [] },
  { type: 'error', name: 'ZeroAccountingAddress', inputs: [] },
  { type: 'error', name: 'ZeroAdminAddress', inputs: [] },
  { type: 'error', name: 'ZeroExitBalance', inputs: [] },
  { type: 'error', name: 'ZeroExitPenaltiesAddress', inputs: [] },
  { type: 'error', name: 'ZeroLocatorAddress', inputs: [] },
  { type: 'error', name: 'ZeroManagerAddress', inputs: [] },
  { type: 'error', name: 'ZeroModuleType', inputs: [] },
  { type: 'error', name: 'ZeroParametersRegistryAddress', inputs: [] },
  { type: 'error', name: 'ZeroPauseDuration', inputs: [] },
  { type: 'error', name: 'ZeroPenaltyType', inputs: [] },
  ...
  },
  {
    ...
    inputs: [{ name: 'maxItems', type: 'uint256', internalType: 'uint256' }],
    outputs: [
      { name: 'removed', type: 'uint256', internalType: 'uint256' },
      { name: 'lastRemovedAtDepth', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      { name: 'queuePriority', type: 'uint256', internalType: 'uint256' },
      { name: 'index', type: 'uint128', internalType: 'uint128' },
    ],
    outputs: [{ name: '', type: 'uint256', internalType: 'Batch' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    ...
    outputs: [
      { name: 'head', type: 'uint128', internalType: 'uint128' },
      { name: 'tail', type: 'uint128', internalType: 'uint128' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'maxKeyCount', type: 'uint256', internalType: 'uint256' }],
    outputs: [{ name: 'pubkeys', type: 'bytes[]', internalType: 'bytes[]' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    ...
    outputs: [
      ...
      { name: 'head', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'topUpQueueLimit', type: 'uint8', internalType: 'uint8' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [{ name: 'to', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  { type: 'error', name: 'DepositQueueIsEmpty', inputs: [] },
  { type: 'error', name: 'InvalidTopUpOrder', inputs: [] },
  { type: 'error', name: 'RewindForward', inputs: [] },
  {
    type: 'error',
  ...
  { type: 'error', name: 'SameTopUpQueueLimit', inputs: [] },
  { type: 'error', name: 'TopUpQueueDisabled', inputs: [] },
  { type: 'error', name: 'TopUpQueueIsEmpty', inputs: [] },
  { type: 'error', name: 'TopUpQueueIsFull', inputs: [] },
  { type: 'error', name: 'UnexpectedExtraKey', inputs: [] },
  { type: 'error', name: 'UpgradeIsNotFinalized', inputs: [] },
  { type: 'error', name: 'ZeroTopUpQueueLimit', inputs: [] },
] as const;
