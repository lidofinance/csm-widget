...
export const SMDiscoveryAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_stakingRouter', type: 'address', internalType: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { name: '_moduleId', type: 'uint256', internalType: 'uint256' },
      { name: '_addressToSearch', type: 'address', internalType: 'address' },
      { name: '_offset', type: 'uint256', internalType: 'uint256' },
      { name: '_limit', type: 'uint256', internalType: 'uint256' },
      { name: '_searchMode', type: 'uint8', internalType: 'enum SearchMode' },
    ],
    outputs: [{ name: '', type: 'uint256[]', internalType: 'uint256[]' }],
    stateMutability: 'view',
  },
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'claimerAddress', type: 'address', internalType: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { name: '_moduleId', type: 'uint256', internalType: 'uint256' },
      { name: '_queuePriority', type: 'uint256', internalType: 'uint256' },
      { name: '_cursorIndex', type: 'uint128', internalType: 'uint128' },
      { name: '_limit', type: 'uint256', internalType: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'accountingAddress', type: 'address', internalType: 'address' },
    ],
    stateMutability: 'view',
  },
  {
    ...
    inputs: [{ name: '_moduleId', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  { type: 'error', name: 'AddressCannotBeZero', inputs: [] },
  {
    ...
    inputs: [
      { name: 'cursor', type: 'uint128', internalType: 'uint128' },
  ...
  { type: 'error', name: 'InvalidStakingRouterAddress', inputs: [] },
  {
    type: 'error',
  ...
  },
  {
    ...
    inputs: [{ name: 'moduleId', type: 'uint256', internalType: 'uint256' }],
  },
  {
    type: 'error',
