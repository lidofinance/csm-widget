...
export const FeeDistributorAbi = [
  ...
  },
  {
    ...
    outputs: [
      { name: 'sharesToDistribute', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_rebateRecipient', type: 'address', internalType: 'address' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_logCid', type: 'string', internalType: 'string' },
      { name: 'distributed', type: 'uint256', internalType: 'uint256' },
      { name: 'rebate', type: 'uint256', internalType: 'uint256' },
      { name: 'refSlot', type: 'uint256', internalType: 'uint256' },
    ],
  ...
  { type: 'error', name: 'FeeSharesDecrease', inputs: [] },
  { type: 'error', name: 'InvalidInitialization', inputs: [] },
  { type: 'error', name: 'InvalidLogCID', inputs: [] },
  { type: 'error', name: 'InvalidProof', inputs: [] },
  { type: 'error', name: 'InvalidRebateRecipientAddress', inputs: [] },
  ...
  { type: 'error', name: 'SameRebateRecipientAddress', inputs: [] },
  { type: 'error', name: 'SenderIsNotAccounting', inputs: [] },
  { type: 'error', name: 'SenderIsNotOracle', inputs: [] },
  { type: 'error', name: 'ZeroAccountingAddress', inputs: [] },
  { type: 'error', name: 'ZeroAdminAddress', inputs: [] },
  { type: 'error', name: 'ZeroOracleAddress', inputs: [] },
  { type: 'error', name: 'ZeroRebateRecipientAddress', inputs: [] },
  { type: 'error', name: 'ZeroStEthAddress', inputs: [] },
] as const;
