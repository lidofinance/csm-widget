...
export const ParametersRegistryAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'queueLowestPriority', type: 'uint256', internalType: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: 'attestationsWeight', type: 'uint32', internalType: 'uint32' },
      { name: 'blocksWeight', type: 'uint32', internalType: 'uint32' },
      { name: 'syncWeight', type: 'uint32', internalType: 'uint32' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: 'priority', type: 'uint32', internalType: 'uint32' },
      { name: 'maxDeposits', type: 'uint32', internalType: 'uint32' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: 'lifetime', type: 'uint32', internalType: 'uint32' },
  ...
  },
  {
    ...
    inputs: [{ name: 'curveId', type: 'uint256', internalType: 'uint256' }],
    outputs: [{ name: 'penalty', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'keysLimit', type: 'uint256', internalType: 'uint256' },
          { name: 'queuePriority', type: 'uint32', internalType: 'uint32' },
          { name: 'queueMaxDeposits', type: 'uint32', internalType: 'uint32' },
          {
          ...
          { name: 'strikesLifetime', type: 'uint256', internalType: 'uint256' },
          {
          ...
          { name: 'blocksWeight', type: 'uint256', internalType: 'uint256' },
          { name: 'syncWeight', type: 'uint256', internalType: 'uint256' },
          {
            name: 'allowedExitDelay',
            type: 'uint256',
            internalType: 'uint256',
          },
          { name: 'exitDelayFee', type: 'uint256', internalType: 'uint256' },
          {
  ...
  },
  {
    ...
    inputs: [{ name: 'curveId', type: 'uint256', internalType: 'uint256' }],
    outputs: [{ name: 'fine', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [{ name: 'curveId', type: 'uint256', internalType: 'uint256' }],
    outputs: [
      { name: 'keyRemovalCharge', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'curveId', type: 'uint256', internalType: 'uint256' }],
    outputs: [
      { name: 'attestationsWeight', type: 'uint256', internalType: 'uint256' },
      { name: 'blocksWeight', type: 'uint256', internalType: 'uint256' },
      { name: 'syncWeight', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'view',
    ...
    outputs: [
      {
        ...
        internalType: 'struct IParametersRegistry.KeyNumberValueInterval[]',
        components: [
          { name: 'minKeyNumber', type: 'uint256', internalType: 'uint256' },
          { name: 'value', type: 'uint256', internalType: 'uint256' },
        ],
      },
    ],
  ...
  },
  {
    ...
    inputs: [{ name: 'delay', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [{ name: 'penalty', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'fine', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'leeway', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'share', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'curveId', type: 'uint256', internalType: 'uint256' },
      { name: 'fine', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  { type: 'error', name: 'InvalidAllowedExitDelay', inputs: [] },
  { type: 'error', name: 'InvalidInitialization', inputs: [] },
  { type: 'error', name: 'InvalidKeyNumberValueIntervals', inputs: [] },
  { type: 'error', name: 'InvalidPerformanceCoefficients', inputs: [] },
  { type: 'error', name: 'InvalidPerformanceLeewayData', inputs: [] },
  { type: 'error', name: 'InvalidRewardShareData', inputs: [] },
  { type: 'error', name: 'InvalidStrikesParams', inputs: [] },
  { type: 'error', name: 'NotInitializing', inputs: [] },
  { type: 'error', name: 'QueueCannotBeUsed', inputs: [] },
  {
    type: 'error',
  ...
  { type: 'error', name: 'ZeroMaxDeposits', inputs: [] },
] as const;
