...
export const VerifierAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'withdrawalAddress', type: 'address', internalType: 'address' },
      { name: 'module', type: 'address', internalType: 'address' },
      { name: 'slotsPerEpoch', type: 'uint64', internalType: 'uint64' },
      {
        name: 'gindices',
        type: 'tuple',
      ...
      { name: 'firstSupportedSlot', type: 'uint64', internalType: 'Slot' },
      { name: 'pivotSlot', type: 'uint64', internalType: 'Slot' },
      { name: 'capellaSlot', type: 'uint64', internalType: 'Slot' },
      { name: 'minWithdrawalRatio', type: 'uint256', internalType: 'uint256' },
  ...
  },
  {
    ...
    name: 'CAPELLA_SLOT',
    inputs: [],
    outputs: [{ name: '', type: 'uint64', internalType: 'Slot' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [],
    outputs: [{ name: '', type: 'bytes32', internalType: 'GIndex' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
            ...
            components: [
              {
                ...
                components: [
                  { name: 'slot', type: 'uint64', internalType: 'Slot' },
                  {
                    name: 'proposerIndex',
                    type: 'uint64',
                    internalType: 'uint64',
            ...
            components: [
              ...
              { name: 'keyIndex', type: 'uint32', internalType: 'uint32' },
              {
                ...
                components: [
                  ...
                  { name: 'exitEpoch', type: 'uint64', internalType: 'uint64' },
                  {
        ...
        components: [
          {
            ...
            components: [
              { name: 'offset', type: 'uint8', internalType: 'uint8' },
              {
                name: 'object',
                type: 'tuple',
  ...
  { type: 'error', name: 'HistoricalSummaryDoesNotExist', inputs: [] },
  { type: 'error', name: 'IndexOutOfRange', inputs: [] },
  { type: 'error', name: 'InvalidBlockHeader', inputs: [] },
  { type: 'error', name: 'InvalidCapellaSlot', inputs: [] },
  { type: 'error', name: 'InvalidChainConfig', inputs: [] },
  { type: 'error', name: 'InvalidMinWithdrawalRatio', inputs: [] },
  { type: 'error', name: 'InvalidPivotSlot', inputs: [] },
  ...
  { type: 'error', name: 'PartialWithdrawal', inputs: [] },
  ...
  { type: 'error', name: 'RootNotFound', inputs: [] },
  {
    type: 'error',
    name: 'UnsupportedSlot',
    inputs: [{ name: 'slot', type: 'uint64', internalType: 'Slot' }],
  },
  { type: 'error', name: 'ValidatorIsNotSlashed', inputs: [] },
  { type: 'error', name: 'ValidatorIsNotWithdrawable', inputs: [] },
  { type: 'error', name: 'ValidatorIsSlashed', inputs: [] },
  { type: 'error', name: 'ValidatorIsWithdrawable', inputs: [] },
  { type: 'error', name: 'ZeroAdminAddress', inputs: [] },
  { type: 'error', name: 'ZeroModuleAddress', inputs: [] },
  { type: 'error', name: 'ZeroPauseDuration', inputs: [] },
  { type: 'error', name: 'ZeroWithdrawalAddress', inputs: [] },
] as const;
