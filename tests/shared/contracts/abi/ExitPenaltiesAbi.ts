...
export const ExitPenaltiesAbi = [
        ...
        components: [
          {
            ...
            components: [
              { name: 'value', type: 'uint248', internalType: 'uint248' },
              { name: 'isValue', type: 'bool', internalType: 'bool' },
            ],
          },
          {
            name: 'strikesPenalty',
  ...
  { type: 'error', name: 'SenderIsNotStrikes', inputs: [] },
  { type: 'error', name: 'ValidatorExitDelayNotApplicable', inputs: [] },
