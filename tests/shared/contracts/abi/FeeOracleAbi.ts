...
export const FeeOracleAbi = [
  {
    ...
    inputs: [
      ...
      { name: 'strikes', type: 'address', internalType: 'address' },
      { name: 'secondsPerSlot', type: 'uint256', internalType: 'uint256' },
      { name: 'genesisTime', type: 'uint256', internalType: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: '', type: 'address', internalType: 'contract IValidatorStrikes' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'refSlot', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'processingStarted', type: 'bool', internalType: 'bool' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'consensusContract', type: 'address', internalType: 'address' },
      { name: 'consensusVersion', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: 'treeCid', type: 'string', internalType: 'string' },
          { name: 'logCid', type: 'string', internalType: 'string' },
          { name: 'distributed', type: 'uint256', internalType: 'uint256' },
          { name: 'rebate', type: 'uint256', internalType: 'uint256' },
          { name: 'strikesTreeRoot', type: 'bytes32', internalType: 'bytes32' },
          { name: 'strikesTreeCid', type: 'string', internalType: 'string' },
        ],
      },
  ...
  { type: 'error', name: 'AddressCannotBeSame', inputs: [] },
  { type: 'error', name: 'AddressCannotBeZero', inputs: [] },
  { type: 'error', name: 'FailedToSendEther', inputs: [] },
  { type: 'error', name: 'HashCannotBeZero', inputs: [] },
  {
    type: 'error',
    name: 'InitialRefSlotCannotBeLessThanProcessingOne',
    inputs: [
      { name: 'initialRefSlot', type: 'uint256', internalType: 'uint256' },
      { name: 'processingRefSlot', type: 'uint256', internalType: 'uint256' },
    ],
  },
  { type: 'error', name: 'InvalidContractVersion', inputs: [] },
  { type: 'error', name: 'InvalidContractVersionIncrement', inputs: [] },
  { type: 'error', name: 'InvalidInitialization', inputs: [] },
  { type: 'error', name: 'NoConsensusReportToProcess', inputs: [] },
  { type: 'error', name: 'NonZeroContractVersionOnInit', inputs: [] },
  ...
  { type: 'error', name: 'RefSlotAlreadyProcessing', inputs: [] },
  {
    type: 'error',
    name: 'RefSlotCannotDecrease',
    inputs: [
      { name: 'refSlot', type: 'uint256', internalType: 'uint256' },
      { name: 'prevRefSlot', type: 'uint256', internalType: 'uint256' },
    ],
  },
  {
    type: 'error',
  ...
  { type: 'error', name: 'SecondsPerSlotCannotBeZero', inputs: [] },
  { type: 'error', name: 'SenderIsNotTheConsensusContract', inputs: [] },
  { type: 'error', name: 'SenderNotAllowed', inputs: [] },
  { type: 'error', name: 'UnexpectedChainConfig', inputs: [] },
  {
    type: 'error',
    name: 'UnexpectedConsensusVersion',
    inputs: [
      { name: 'expectedVersion', type: 'uint256', internalType: 'uint256' },
      { name: 'receivedVersion', type: 'uint256', internalType: 'uint256' },
    ],
  },
  {
    type: 'error',
  ...
  },
  {
    ...
    inputs: [
      { name: 'consensusHash', type: 'bytes32', internalType: 'bytes32' },
      { name: 'receivedHash', type: 'bytes32', internalType: 'bytes32' },
    ],
  },
  {
    type: 'error',
    ...
    inputs: [
      { name: 'consensusRefSlot', type: 'uint256', internalType: 'uint256' },
      { name: 'dataRefSlot', type: 'uint256', internalType: 'uint256' },
    ],
  },
  { type: 'error', name: 'VersionCannotBeSame', inputs: [] },
  { type: 'error', name: 'VersionCannotBeZero', inputs: [] },
  ...
  { type: 'error', name: 'ZeroStrikesAddress', inputs: [] },
] as const;
