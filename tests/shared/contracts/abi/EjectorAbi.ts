...
export const EjectorAbi = [
  ...
  { type: 'error', name: 'DuplicateKeyIndex', inputs: [] },
  { type: 'error', name: 'NodeOperatorDoesNotExist', inputs: [] },
  { type: 'error', name: 'NothingToEject', inputs: [] },
