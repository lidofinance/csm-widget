...
export const CuratedModuleAbi = [
  ...
  { type: 'error', name: 'ZeroSenderAddress', inputs: [] },
  {
    ...
    inputs: [
      ...
      { name: 'metaRegistry', type: 'address', internalType: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: '', type: 'address', internalType: 'contract IMetaRegistry' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'externalStake', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
    ...
    outputs: [
      { name: 'operatorWeights', type: 'uint256[]', internalType: 'uint256[]' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'nodeOperatorId', type: 'uint256', internalType: 'uint256' },
      { name: 'oldWeight', type: 'uint256', internalType: 'uint256' },
      { name: 'newWeight', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  { type: 'error', name: 'InvalidSigningKey', inputs: [] },
  { type: 'error', name: 'SenderIsNotMetaRegistry', inputs: [] },
  { type: 'error', name: 'ZeroMetaRegistryAddress', inputs: [] },
] as const;
