...
// Back-compat: the static copy map derived from ERROR_META.
export const ErrorMessages: Record<ErrorCode, ReactNode> = Object.fromEntries(
  Object.entries(ERROR_META).map(([code, meta]) => [code, meta.message]),
) as Record<ErrorCode, ReactNode>;
