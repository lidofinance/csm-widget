...
export const validationMessage = {
  ...
  // was: 'Keys limit exceeded. Allowed keys count to submit: N.' — two-sentence dot violation
  keysLimitExceeded: (allowed: number): string =>
    `Keys limit exceeded, allowed keys to submit: ${allowed}`,
