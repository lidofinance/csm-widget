...
const Step: FC<PropsWithChildren<{ number: string; title: string }>> = ({
  number,
  title,
  children,
}) => {
  ...
  return (
    <Stack direction="column" gap="md">
      ...
      <Step number="1" title="Application submission">
        People interested in being included in the Identified DVT Cluster list
        must submit an application on the &quot;
        <LocalLink href={PATH.TYPE_IDVTC_APPLY}>Application form</LocalLink>
        &quot; sub-tab
      </Step>
