    ...
    return _a = class CoreSDK extends _classSuper {
            ...
            async performTransaction(props) {
                ...
                if (isContract) {
                    ...
                    await callback({ stage: lido_ethereum_sdk_1.TransactionCallbackStage.GAS_LIMIT });
                ...
                const customGas = await callback({
                    stage: lido_ethereum_sdk_1.TransactionCallbackStage.SIGN,
                ...
                if (isContract) {
                    await callback({ stage: lido_ethereum_sdk_1.TransactionCallbackStage.MULTISIG_DONE });
                    return { hash };
                }
                await callback({
                    stage: lido_ethereum_sdk_1.TransactionCallbackStage.RECEIPT,
                    payload: { hash },
                });
                ...
                await callback({
                    stage: lido_ethereum_sdk_1.TransactionCallbackStage.CONFIRMATION,
                ...
                await callback({
                    stage: lido_ethereum_sdk_1.TransactionCallbackStage.DONE,
                    payload: {
                        result: result,
                        confirmations,
                        receipt,
