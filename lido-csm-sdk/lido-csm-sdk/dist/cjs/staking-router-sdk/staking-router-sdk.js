...
exports.StakingRouterSDK = void 0;
...
let StakingRouterSDK = (() => {
    ...
    return _a = class StakingRouterSDK extends _classSuper {
            ...
            calculateShareLimit(digests) {
                const moduleId = index_js_1.MODULE_ID_BY_CHAIN[this.core.chainId];
                (0, lido_ethereum_sdk_1.invariant)(moduleId, `CSM moduleId is not specified for ${this.core.chain.name}(${this.core.chain.id})`, lido_ethereum_sdk_1.ERROR_CODE.NOT_SUPPORTED);
                const moduleDigest = digests.find((digest) => digest.state.id === moduleId);
                (0, lido_ethereum_sdk_1.invariant)(moduleDigest, `CSM module (${moduleId}) is not connected to StakingRouter`, lido_ethereum_sdk_1.ERROR_CODE.NOT_SUPPORTED);
            ...
            async getShareLimitStatus(shareLimitThreshold = 200n) {
                ...
                return info.activeLeft <= 0
                    ? types_js_1.ShareLimitStatus.REACHED
                    : info.activeLeft - info.queue < 0
                        ? types_js_1.ShareLimitStatus.EXHAUSTED
                        : info.activeLeft - info.queue < shareLimitThreshold
                            ? types_js_1.ShareLimitStatus.APPROACHING
                            : types_js_1.ShareLimitStatus.FAR;
            }
            constructor() {
                super(...arguments);
        ...
        (() => {
            ...
            _getAllModulesDigests_decorators = [(0, logger_js_1.Logger)('Views:'), (0, error_handler_js_1.ErrorHandler)()];
            _getShareLimit_decorators = [(0, logger_js_1.Logger)('Utils:'), (0, cache_js_1.Cache)(10 * 60 * 1000)];
            _getShareLimitStatus_decorators = [(0, logger_js_1.Logger)('Utils:')];
...
exports.StakingRouterSDK = StakingRouterSDK;
