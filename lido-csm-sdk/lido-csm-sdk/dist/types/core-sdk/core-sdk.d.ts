...
export declare class CoreSDK extends CsmSDKCacheable {
  ...
  getContractCSAccounting(): GetContractReturnType<
    typeof CSAccountingAbi,
    WalletClient
  >;
  getContractCSEjector(): GetContractReturnType<
    typeof CSEjectorAbi,
    WalletClient
  >;
  getContractCSFeeDistributor(): GetContractReturnType<
    typeof CSFeeDistributorAbi,
    WalletClient
  >;
  getContractCSFeeOracle(): GetContractReturnType<
    typeof CSFeeOracleAbi,
    WalletClient
  >;
  getContractCSModule(): GetContractReturnType<
    typeof CSModuleAbi,
    WalletClient
  >;
  getContractCSParametersRegistry(): GetContractReturnType<
    typeof CSParametersRegistryAbi,
    WalletClient
  >;
  getContractCSStrikes(): GetContractReturnType<
    typeof CSStrikesAbi,
    WalletClient
  >;
  getContractCSVerifier(): GetContractReturnType<
    typeof CSVerifierAbi,
    WalletClient
  >;
  getContractHashConsensus(): GetContractReturnType<
    typeof HashConsensusAbi,
    WalletClient
  >;
  getContractPermissionlessGate(): GetContractReturnType<
    typeof PermissionlessGateAbi,
    WalletClient
  >;
  getContractVettedGate(): GetContractReturnType<
    typeof VettedGateAbi,
    WalletClient
  >;
  getContractStakingRouter(): GetContractReturnType<
    typeof StakingRouterAbi,
    WalletClient
  >;
  getContractValidatorsExitBusOracle(): GetContractReturnType<
    typeof ValidatorsExitBusOracleAbi,
    WalletClient
  >;
  performTransaction<TDecodedResult = undefined>(
