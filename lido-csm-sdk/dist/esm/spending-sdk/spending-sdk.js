...
import { CSM_CONTRACT_NAMES, EMPTY_PERMIT, STETH_ROUNDING_THRESHOLD, TOKENS, } from '../common/index.js';
import { TransactionCallbackStage, } from '../core-sdk/types.js';
let SpendingSDK = (() => {
    var _a;
    ...
    return _a = class SpendingSDK extends _classSuper {
        ...
        (() => {
            ...
            _checkAllowance_decorators = [Logger('Utils:'), ErrorHandler()];
            _approve_decorators = [Logger('Call:'), ErrorHandler()];
            _isMultisig_decorators = [Logger('Views:')];
            _signPermitOrApprove_decorators = [Logger('Utils:')];
