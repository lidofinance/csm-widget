...
let RewardsSDK = (() => {
    ...
    return _a = class RewardsSDK extends _classSuper {
            ...
            async getProofTree() {
                ...
                return (0, fetch_json_js_1.fetchWithFallback)(urls, (url) => (0, fetch_rewards_tree_js_1.fetchRewardsTree)(url, root));
            }
            ...
            async getLastReport() {
                ...
                return (0, fetch_json_js_1.fetchWithFallback)(urls, (url) => (0, fetch_json_js_1.fetchJson)(url));
            }
            async getOperatorRewardsInLastReport(nodeOperatorId) {
                const report = await this.getLastReport();
                if (!report)
                    return undefined;
                const { distributed: shares, ...rest } = (0, find_operator_rewards_js_1.findOperatorRewards)(nodeOperatorId, report);
        ...
        (() => {
            ...
            _getLogUrls_decorators = [(0, index_js_1.Logger)('Utils:')];
            ...
            _getLastFrame_decorators = [(0, index_js_1.Logger)('Views:'), (0, index_js_1.ErrorHandler)()];
            _getLastReport_decorators = [(0, index_js_1.Logger)('Views:'), (0, index_js_1.ErrorHandler)()];
            _getOperatorRewardsInLastReport_decorators = [(0, index_js_1.Logger)('Utils:')];
            _getLastReportTransactionHash_decorators = [(0, index_js_1.Logger)('Utils:')];
