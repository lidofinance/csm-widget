...
const on_error_js_1 = require("./on-error.js");
let ModuleSDK = (() => {
    var _a;
    ...
    return _a = class ModuleSDK extends _classSuper {
            ...
            async getVersions() {
                ...
                const [module, accounting, feeDistributor] = await Promise.all([
                    csModule.read.getInitializedVersion().catch(on_error_js_1.onError),
                    csAccounting.read.getInitializedVersion().catch(on_error_js_1.onError),
                    csFeeDistributor.read.getInitializedVersion().catch(on_error_js_1.onError),
                ]);
                return {
        ...
        (() => {
            ...
            _getOperatorsCount_decorators = [(0, index_js_1.Logger)('Views:'), (0, index_js_1.ErrorHandler)()];
            _getQueues_decorators = [(0, index_js_1.Logger)('Views:'), (0, index_js_1.ErrorHandler)()];
