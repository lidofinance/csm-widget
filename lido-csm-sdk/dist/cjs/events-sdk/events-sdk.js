...
let EventsSDK = (() => {
    ...
    return _a = class EventsSDK extends _classSuper {
            ...
            async getNodeOperatorsByAddress(address, options) {
                ...
                const logs = logResults.flat().sort(sort_events_js_1.sortEventsByBlockNumber);
            ...
            async getRewardsReports(options) {
                const stepConfig = await this.parseEventsProps(options);
                const logResults = await Promise.all((0, request_with_block_step_js_1.requestWithBlockStep)(stepConfig, (stepProps) => this.oracleContract.getEvents.ProcessingStarted(undefined, stepProps)));
                const logs = logResults.flat().sort(sort_events_js_1.sortEventsByBlockNumber);
                return logs;
            }
        ...
        (() => {
            ...
            _getRewardsReports_decorators = [(0, index_js_1.Logger)('Events:'), (0, index_js_1.ErrorHandler)()];
