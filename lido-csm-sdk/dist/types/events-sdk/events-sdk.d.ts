...
export declare class EventsSDK extends CsmSDKModule {
    protected get contract(): GetContractReturnType<typeof CSModuleAbi, WalletClient>;
    protected get contractV1Events(): GetContractReturnType<typeof CSModulev1EventsAbi, WalletClient>;
    private get oracleContract();
    getNodeOperatorsByAddress(address: Address, options?: EventRangeProps): Promise<NodeOperator[]>;
    getInvitesByAddress(address: Address, options?: EventRangeProps): Promise<NodeOperatorInvite[]>;
    getRewardsReports(options?: EventRangeProps): Promise<import("viem").Log<bigint, number, false, undefined, undefined, readonly [{
